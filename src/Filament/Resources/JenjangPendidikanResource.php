...
use Kanekescom\Simgtk\Filament\Resources\JenjangPendidikanResource\Pages;
use Kanekescom\Simgtk\Models\JenjangPendidikan;
use pxlrbt\FilamentExcel\Actions\Tables\ExportBulkAction;
use pxlrbt\FilamentExcel\Columns\Column;
use pxlrbt\FilamentExcel\Exports\ExcelExport;

class JenjangPendidikanResource extends Resource implements HasShieldPermissions
{
    protected static ?string $slug = 'referensi/kependidikan/jenjang-pendidikan';
    ...
    {
        return [
            'index' => Pages\ListJenjangPendidikan::route('/'),
